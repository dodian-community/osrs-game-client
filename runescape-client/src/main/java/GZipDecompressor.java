...
public class GZipDecompressor {
	...
	public void decompress(Buffer var1, byte[] var2) {
		if (var1.payload[var1.offset] == 31 && var1.payload[var1.offset + 1] == -117) { // L: 16
			if (this.inflater == null) { // L: 17
				this.inflater = new Inflater(true);
			}

			try {
				this.inflater.setInput(var1.payload, var1.offset + 10, var1.payload.length - (var1.offset + 8 + 10)); // L: 19
